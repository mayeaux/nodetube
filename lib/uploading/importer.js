  ...
  try {
    ...
    if(lastThumbnail){
      ...
      if(1 == 1){
        ...
        arguments.push('bestvideo[tbr<4400][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4][tbr<4400]/best[ext=mp4]');
      }
      ...
      ls.stdout.on('data', data => {
        ...
        // TODO: add a regexp here, to trim data off of the object (like path and stuff)
