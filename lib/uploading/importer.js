...
async function checkIfUploadedByTitleAndId(channelUrl, title, youTubeUploadId){
  ...
  const alreadyExistsById= await Upload.findOne({
    channelUrl,
    'youTubeDLData.id': youTubeUploadId,
    visibility: 'public',
    status: 'completed'
  });
