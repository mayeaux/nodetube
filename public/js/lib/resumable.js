        ...
        processCallbacks(
          entries.map(entry =>
            // bind all properties except for callback
             processItem.bind(null, entry, path, items)),
          cb,
        );
      });
    }
    ...
    function loadFiles(items, event) {
      ...
      processCallbacks(
        Array.prototype.map.call(items, item =>
          // bind all properties except for callback
           processItem.bind(null, item, '', files)),
        () => {
          if (files.length) {
